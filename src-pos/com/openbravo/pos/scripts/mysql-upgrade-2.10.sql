...
-- ASOCIACION ENTRE LAS PLANTAS Y LAS UBICACIONES
ALTER TABLE FLOORS ADD COLUMN LOCATION VARCHAR(45) NULL AFTER IMAGE, ADD CONSTRAINT FLOOR_LOCATION FOREIGN KEY (LOCATION) REFERENCES LOCATIONS(ID) ON DELETE NO ACTION ON UPDATE NO ACTION, ADD INDEX FLOOR_LOCATION (LOCATION ASC);
